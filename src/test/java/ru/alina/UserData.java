...
public class UserData {
    public static final User USER1 = new User(1L, "mail@Mail.com", "$2a$12$FzYWgZ.ukSJS9KAtZZvHkOVw5iOGKibZlenQ1AxytGbnBAmGPaP9y", Gender.MALE, 180, 55, Activity.MIN, 100.0d, 90.0d, 2000, Role.USER);
    public static final User USER2 = new User(2L, "pochta@Mail.com", "$2a$12$h5yDKri/.IjvfHrziaQ.QejnQmhSKmEXg4zHq6CVGM5IWkr.GiqPG", Gender.FEMALE, 150, 16, Activity.MIN, 55.0, 40.0, 1000, Role.USER);

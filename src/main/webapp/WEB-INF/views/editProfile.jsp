        ...
        <div class="col-8">
            ...
            <form action="${pageContext.request.contextPath}/profileForm" method="post">
                <div class="form-group">
                    <div class="form-qw">
                        <span class="form-qw-header">Gender</span>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="male" value="male"
                            <c:if test="${profile.gender.name().equals('MALE')}"> checked </c:if> >
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="female" value="female" <c:if
                                    test="${profile.gender.name().equals('FEMALE')}"> checked </c:if>>
                    ...
                    <div class="form-qw">
                        ...
                        <div class="form-check">
                            ...
                            <c:if test="${profile.activity.name().equals('WEAK')}"> checked </c:if> >
                        ...
                        <div class="form-check">
                            ...
                            <c:if test="${profile.activity.name().equals('MIDDLE')}"> checked </c:if> >
                        ...
                        <div class="form-check">
                            ...
                            <c:if test="${profile.activity.name().equals('GREAT')}"> checked </c:if> >
                        ...
                        <div class="form-check">
                            ...
                            <c:if test="${profile.activity.name().equals('MAX')}"> checked </c:if> >
                            <label class="form-check-label" for="male">
                    ...
                    <div class="form-qw">
                        <label for="start-weight" class="col-form-label form-qw-header">Current weight</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="start-weight"
                               name="startWeight" value="${profile.startWeight}">
                    </div>

                    <div class="form-qw">
                        <label for="desired-weight" class="col-form-label form-qw-header">Desired Weight</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="desired-weight"
                               name="desiredWeight" value="${profile.desiredWeight}">
                    </div>
